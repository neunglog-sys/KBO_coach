  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          {/* 글자 ✕는 화면 배율마다 위치가 달라져서 SVG로 교체 — 기하학적 정중앙, 배율 무관 */}
          <svg width="14" height="14" viewBox="0 0 14 14" aria-hidden="true" style={{ display: "block" }}>
            <path d="M3 3 L11 11 M11 3 L3 11" stroke="#1f2937" strokeWidth="2" strokeLinecap="round" fill="none" />
          </svg>
        </button>
        ...
        <div
          style={{
            ...
            padding: "10px 14.5px 8px 9.5px", // 기하학적 정가운데(13/11)에서 1.5px 왼쪽 이동 — '룸' 글자가 우측을 꽉 채우는 착시 보정 (사장님 피드백)
            borderRadius: 999,
